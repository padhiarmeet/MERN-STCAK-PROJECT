...
const CreateBook = () => {
  ...
  const hendleSaveBook = () => {
    ...
    setLoading(true);
    axios.post('http://localhost:3003/books', data)
      .then(() => {
        setLoading(false);
        navigate('/');
      })
  ...
  return (
    <>
      <div className='p-4'>
        ...
        <div className='flex-col border border-slate-500 rounded-sm w-[600px] p-4 mx-auto'>
